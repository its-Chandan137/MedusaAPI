    ...
    return (
        <>
            <section className="content flex justify-between lg:px-16 h-[50vh] lg:h-[90vh] relative z-20">
                ...
                <div className="right bg-white p-5 w-1/2 h-[100vh] flex justify-center items-center relative z-50">
                    <img
                        src={image}
                        alt="image"
                ...
                <div className="lg:bg-black lg:h-[100vh] lg:absolute lg:top-0 lg:right-0 lg:w-1/3 lg:-z-10"></div>
            </section>
        </>
    );
};
...
const Banner = ()=>{
    return (
        <div className="py-20 container flex flex-col lg:flex-row items-center gap-5">
            <div>
                <BannerCard title="Wooden Water Bottle" desc="UP TO 60% OFF" cover="../images/hero/product1-1.png"/>
            </div>
    ...
    return(
        <>
            <div className="w-full h-full relative">
                ...
                <div className={`${className? "absolute bottom-0 p-8 w-full"
